...
public interface ZoneRepository extends JpaRepository<Zone , UUID> {
    ...
    List<Zone> findByTemplateIdAndTemplateUserId(UUID templateId, UUID userId);
    List<Zone> findByTemplateOverrideIdAndTemplateOverrideUserId(UUID templateOverrideId, UUID userId);
